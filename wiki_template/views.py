...
class TemplateCreateView(ArticleMixin, FormView):
    ...
    template_name = "wiki_template/template_create.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        ac = ArticleMixin.get_context_data(self, **kwargs)
        c.update(ac)
        c['selected_tab'] = 'template'
        c['urlpath'] = self.urlpath
...
class TemplateView(ArticleMixin, DjTemplateView):
    ...
    template_name = "wiki_template/index.html"
...
class TemplateHistoryView(ArticleMixin, DjTemplateView):
    ...
    template_name = "wiki_template/history.html"
...
class RevisionAddView(ArticleMixin, FormView):
    ...
    template_name = "wiki_template/revision_add.html"
...
class TemplateDeleteView(ArticleMixin, FormView):
    ...
    template_name = "wiki_template/delete.html"
...
class TemplateSearchView(ArticleMixin, ListView):
    ...
    template_name = "wiki_template/search.html"
    allow_empty = True
